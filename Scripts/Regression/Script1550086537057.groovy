...
url = findTestData("IntegrationsInputData").getValue("url", 1)
usr = findTestData("IntegrationsInputData").getValue("user", 1)
pwd = findTestData("IntegrationsInputData").getValue("password", 1)
msg = findTestData("IntegrationsInputData").getValue("sendMsg", 1)
dbip = findTestData("IntegrationsInputData").getValue("dbIP", 1)
dbport = findTestData("IntegrationsInputData").getValue("dbPort", 1)
dbgrp = findTestData("IntegrationsInputData").getValue("dbGroup", 1)
dbusr = findTestData("IntegrationsInputData").getValue("dbUsr", 1)
dbpwd = findTestData("IntegrationsInputData").getValue("dbPwd", 1)
